...
public class DetailsInfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonPersonal.setBackground(new java.awt.Color(0, 60, 98));
        ...
        jButtonPersonal.setPreferredSize(new java.awt.Dimension(350, 50));
        ...
        jButtonAccount1.setBackground(new java.awt.Color(0, 60, 98));
        ...
        jButtonAccount1.setPreferredSize(new java.awt.Dimension(350, 50));
        ...
        jButtonMoneytransfer.setBackground(new java.awt.Color(0, 60, 98));
        ...
        jButtonLogOut.setBackground(new java.awt.Color(0, 119, 182));
        jButtonLogOut.setFont(new java.awt.Font("Ubuntu", 1, 14)); // NOI18N
        jButtonLogOut.setForeground(new java.awt.Color(253, 251, 251));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(jButtonAccount1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                        .addComponent(jButtonPersonal, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                        .addComponent(jButtonMoneytransfer, javax.swing.GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jButtonAccount1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jButtonMoneytransfer, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(45, 45, 45)
                        .addComponent(jButtonLogOut)
    ...
    private void jButtonAccount1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAccount1ActionPerformed
        ...
        try
        {
            Connection mycon=DriverManager.getConnection("jdbc:mysql://localhost:3306/bankmanagementsystem?zeroDateTimeBehavior=convertToNull","root","");
            String s1="",s2="",s3="";
            String y="Select * from account where Account_no=(select Account_no from customer where username='"+u+"' )";
    ...
    private void jButtonMoneytransferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMoneytransferActionPerformed
        ...
        try
        {
            Connection mycon=DriverManager.getConnection("jdbc:mysql://localhost:3306/bankmanagementsystem?zeroDateTimeBehavior=convertToNull","root","");
            String s1="";
            String y="Select Account_no from account where Account_no= (select Account_no from customer where username='"+u+"' )";
            Statement st=mycon.createStatement();
            PreparedStatement p=mycon.prepareStatement(y);
            ResultSet r=p.executeQuery();
            if(r.next())
